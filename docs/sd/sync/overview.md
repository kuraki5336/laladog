...
| POST   | `/sync/collections`                 | 上傳新的共享 Collection | editor / owner      | [上傳Collection](./上傳Collection.md)         |
| PUT    | `/sync/collections/{collection_id}` | 更新共享 Collection     | editor / owner      | [更新共享Collection](./更新共享Collection.md) |
| DELETE | `/sync/collections/{collection_id}` | 刪除共享 Collection     | owner               | [刪除共享Collection](./刪除共享Collection.md) |
